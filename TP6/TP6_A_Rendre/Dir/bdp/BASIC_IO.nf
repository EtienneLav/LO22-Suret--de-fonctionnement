...
THEORY ListPreconditionX IS
  List_Precondition(Machine(BASIC_IO),INTERVAL_READ)==(nn: INT & mm: INT & mm<=nn);
  List_Precondition(Machine(BASIC_IO),INT_WRITE)==(vv: INT);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(BASIC_IO),INT_WRITE)==(vv: INT | skip);
  Expanded_List_Substitution(Machine(BASIC_IO),INTERVAL_READ)==(nn: INT & mm: INT & mm<=nn | @(bb$0).(bb$0: mm..nn ==> bb:=bb$0));
